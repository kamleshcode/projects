...
?>
    <div class="container"  style='margin-top:70px;'>
		...
		<div class="row centered-form" data-aos="zoom-in" class="div" data-aos-duration="1500">
					...
					<?php
						if(isset($_POST["submit"]))
						{
								...
								else
								{
								 ...
								 $sql="INSERT INTO request_blood(NAME,GENDER,BLOOD,BUNIT,HOSP,CITY,PIN,DOC,RDATE,CNAME,EMAIL,CON1,REASON,CADDRESS)
								 VALUES('{$_POST["NAME"]}','{$_POST["GENDER"]}','{$_POST["BLOOD"]}','{$_POST["BUNIT"]}','{$_POST["HOSP"]}','{$_POST["CITY"]}','{$_POST["PIN"]}','{$_POST["DOC"]}','{$_POST["RDATE"]}','{$_POST["CNAME"]}','{$_POST["EMAIL"]}','{$_POST["CON1"]}','{$_POST["REASON"]}','{$_POST["CADDRESS"]}')";
									if($con->query($sql))
									{
