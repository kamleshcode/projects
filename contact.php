...
?>
    ...
    <!-- Page Content -->
    <div class="container" style="margin-top:70px;"  data-aos="zoom-in" class="div" data-aos-duration="2000">
            ...
            <div class="col-md-4"  data-aos="fade-up" class="div" data-aos-duration="2000">
                ...
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Phone no</abbr>: 0000000000</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email-id</abbr>: <a href="#" >example@gmail.com</a>
                </p>
