...
?>
    <div class="container" style='margin-top:70px;'>
        <div class="row" data-aos="fade-down" class="div" data-aos-duration="1000">
            <div class="col-md-12">
...
(NAME, FATHER_NAME, GENDER, DOB, BLOOD, BODY_WEIGHT, EMAIL, ADDRESS, AREA, CITY, PINCODE, STATE, CONTACT_1,NEW_DONOR, LAST_D_DATE,COUNTRY)
 VALUES 
 ('{$_POST["NAME"]}', '{$_POST["FATHER_NAME"]}', '{$_POST["GENDER"]}', '{$_POST["DOB"]}', '{$_POST["BLOOD"]}', '{$_POST["BODY_WEIGHT"]}', '{$_POST["EMAIL"]}', '{$_POST["ADDRESS"]}', '{$_POST["AREA"]}', '$cityname', '{$_POST["PINCODE"]}', '{$state}', '{$_POST["CONTACT_1"]}', '{$_POST["NEW_DONOR"]}','{$_POST["LAST_D_DATE"]}','{$country}');";
						if($con->query($sql))
							{
								echo '
				...
				?>
                <div class="panel panel-primary" data-aos="zoom-in" class="div" data-aos-duration="1500">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="form-group" data-aos="fade-up-left" class="div" data-aos-duration="500">
